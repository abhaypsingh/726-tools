// Learning Ladder - Build learning progressions
export default {
    init() {
        return {
            input: '',
            output: null,
            processing: false,
            history: JSON.parse(localStorage.getItem('learning-ladder-history') || '[]'),
            settings: JSON.parse(localStorage.getItem('learning-ladder-settings') || '{}')
        };
    },
    ...
    render(container, state, setState) {
        container.innerHTML = `
            <div class="utility-workspace">
                ...
                <p>Build learning progressions</p>
    ...
    process(state, setState) {
        ...
        setTimeout(() => {
            ...
            localStorage.setItem('learning-ladder-history', JSON.stringify(state.history));
        }, 1000);
    },
    ...
    help() {
        return `
            <ul>
                <li>Build learning progressions</li>
