// Reflection Refractor - Split reflections into insights
export default {
    init() {
        return {
            input: '',
            output: null,
            processing: false,
            history: JSON.parse(localStorage.getItem('reflection-refractor-history') || '[]'),
            settings: JSON.parse(localStorage.getItem('reflection-refractor-settings') || '{}')
        };
    },
    ...
    render(container, state, setState) {
        container.innerHTML = `
            <div class="utility-workspace">
                <h2>Reflection Refractor</h2>
                <p>Split reflections into insights</p>
    ...
    process(state, setState) {
        ...
        setTimeout(() => {
            ...
            localStorage.setItem('reflection-refractor-history', JSON.stringify(state.history));
        }, 800);
    },
    ...
    help() {
        return `
            <ul>
                <li>Split reflections into insights</li>
