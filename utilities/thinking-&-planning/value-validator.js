// Value Validator - Test decisions against values
export default {
    init() {
        return {
            input: '',
    ...
    render(container, state, setState) {
        container.innerHTML = `
            <div class="utility-workspace">
                ...
                <p>Test decisions against values</p>
    ...
    process(state, setState) {
        ...
        setTimeout(() => {
            ...
            localStorage.setItem('value-validator-history', JSON.stringify(state.history));
        }, 200);
    },
    ...
    help() {
        return `
            <ul>
                <li>Test decisions against values</li>
