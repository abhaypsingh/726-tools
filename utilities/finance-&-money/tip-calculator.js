// Tip Calculator - A utility in the Finance & Money category
export default {
    init() {
        return {
            input: '',
            results: [],
            settings: JSON.parse(localStorage.getItem('tip-calculator-settings') || '{}'),
            history: JSON.parse(localStorage.getItem('tip-calculator-history') || '[]')
        };
    },
    ...
    process(input) {
        // Processing logic for Tip Calculator
