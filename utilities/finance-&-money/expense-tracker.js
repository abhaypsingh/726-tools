// Expense Tracker - A utility in the Finance & Money category
export default {
    init() {
        return {
            input: '',
            ...
            history: JSON.parse(localStorage.getItem('expense-tracker-history') || '[]')
        };
    },
        ...
        if (processBtn) {
            processBtn.addEventListener('click', () => {
                if (state.input) {
                    ...
                    localStorage.setItem('expense-tracker-history', JSON.stringify(newHistory));
                    setState({
                        results: [result],
                        history: newHistory
                    });
    ...
    process(input) {
        // Processing logic for Expense Tracker
