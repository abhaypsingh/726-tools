// Loan Calculator - A utility in the Finance & Money category
export default {
    init() {
        return {
            input: '',
            results: [],
            settings: JSON.parse(localStorage.getItem('loan-calculator-settings') || '{}'),
            history: JSON.parse(localStorage.getItem('loan-calculator-history') || '[]')
        };
    },
    ...
    process(input) {
        // Processing logic for Loan Calculator
