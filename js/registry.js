// 726 Tools Registry - Auto-generated on 2025-09-24T17:39:22.035Z
export const UtilityRegistry = {
    ...
    },
    {
        ...
        "name": "Performance Dashboard",
        "category": "productivity tools",
        "description": "Monitor and track your overall performance metrics",
        "complexity": "beginner"
    },
    {
        "id": "priority-matrix",
    ...
    },
    {
        ...
        "name": "Boundary Builder",
        "category": "thinking & planning",
        "description": "Design clear personal boundaries and practice enforcing them with confidence",
        "complexity": "advanced"
    },
    {
        "id": "clarity-compass",
    ...
    },
    {
        ...
        "name": "Idea Incubator",
        "category": "thinking & planning",
        "description": "Let ideas mature and develop over time",
        "complexity": "intermediate"
    },
    {
    ...
    getByCategory(category) {
        return this.utilities.filter(util =>
            util.category.toLowerCase() === category.toLowerCase()
        );
    },

    getCategories() {
        const categories = [...new Set(this.utilities.map(util => util.category))];
    ...
    search(query) {
        ...
        return this.utilities.filter(util =>
            ...
            util.category.toLowerCase().includes(lowerQuery)
        );
    },

    getByComplexity(complexity) {
        return this.utilities.filter(util => util.complexity === complexity);
    },
    ...
    getStatistics() {
        ...
        this.utilities.forEach(util => {
            // Count by category
            if (!stats.byCategory[util.category]) {
                stats.byCategory[util.category] = 0;
            }
            stats.byCategory[util.category]++;

            // Count by complexity
            stats.byComplexity[util.complexity]++;
        });
